...
const Cart = () => {
    ...
    return (
        <>
            ...
            <FaCartArrowDown className="fixed right-2 bottom-10 text-5xl p-3 rounded-2xl bg-white  hover:bg-green-400 transition-all ease-in-out duration-1000" onClick={ () => setActiveCart(!ActiveCart)}/>
        </>
    );
}
